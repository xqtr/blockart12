...
Begin
  ...
  GetDir(0,DataPath);
  RomFile := GetUploadFilename(' ROM File ',DataPath,'*.gb');
...
Repeat
  ...
  //WriteXYPipe(17,25,7,'|15W|08/|15E |07Scroll Line |15S|08/|15D |07Scroll Pos. |15X|08/|15C |07Scroll Page |15ENTER |07Select |15ESC |07Quit');
